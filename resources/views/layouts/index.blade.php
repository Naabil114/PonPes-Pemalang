                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item {{ request()->routeIs('komponen_spp.*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ request()->routeIs('komponen_spp.*') ? 'show' : '' }}"
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li class="{{ request()->routeIs('tagihan-santri.*') ? 'active' : '' }}">
                                        <a href="{{ route('tagihan-santri.index') }}">
                                            <span class="sub-item">Data Tagihan</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-section">
                            ...
                            <h4 class="text-section">Santri</h4>
                        </li>

                        <li class="nav-item {{ request()->routeIs('tagihan.pembayaran.santri.index') ? 'active' : '' }}">
                            <a href="{{ route('tagihan.pembayaran.santri.index') }}">
                                <i class="fas fa-user-shield"></i>
                                <p>Tagihan</p>
                            </a>
                        </li>
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg d-flex align-items-center justify-content-center bg-primary text-white rounded"
