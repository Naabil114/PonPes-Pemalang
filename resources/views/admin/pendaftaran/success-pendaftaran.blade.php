...
<head>
    ...
    <style>
        ...
        .icon-container {
            font-size: 5rem; /* Ukuran ikon lebih besar */
        ...
        .btn-whatsapp {
            ...
            border-radius: 50px; /* Tombol berbentuk pil */
                ...
                <div class="card text-center p-4 p-md-5 success-card">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted lead mb-4">
                            Alhamdulillah, Anda telah terdaftar sebagai calon santri. Silahkan hubungi admin untuk melakukan proses verifikasi lebih lanjut.
                        </p>
