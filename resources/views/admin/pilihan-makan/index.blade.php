                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Data pilih makan santri</h4>
                                <div class="ms-auto">
                                    <a href="{{ route('pilihan-makan-santri.create') }}">
                                        <button class="btn btn-primary btn-round ms-auto">
                                            <i class="fa fa-plus"></i>
                                            Tambah pilih makan santri
                                        </button>
                                    </a>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->bulan }}</td>
                                                <td>{{ $item->tahun }}</td>
                                                <td>{{ $item->jenis_makan }}</td>
                                                <td>{{ $item->tanggal_pilih }}</td>
                                                <td>
                                                    <div class="form-button-action d-flex gap-2">


                                                        <!-- Tombol Edit -->
                                                        <a href="{{ route('pilihan-makan-santri.edit', $item->id_pilihan_makan) }}">
